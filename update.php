...
$sql = "UPDATE product_db SET productName = '$productName', productPrice = '$productPrice', productCategory = '$productCategory', productDescription = '$productDescription' WHERE productID = '$productID'";
...
<h1 class="text-center my-5">Update Product Management System</h1>
<div class="row ">
...
<div class=" mx-3 shadow p-4 mb-5">
   <form   method="POST" >
              ...
              <button   type="submit" id="mainBtn" class="btn btn-dark fw-bold border-2 rounded-pill  my-3">Update</button>
